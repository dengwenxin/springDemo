...
var _baseURL = "http://rili.zhwnl.cn/";
var _uId = "";
$(function() {
    // 设置用户名
    // setUserName();
    ...
    for (var year = 1900; year < 2051; year++) {
        $("#yearjpDDM").append($('<option></option>').html(year));
    }
    
    $("#yearjpDDM").click(function() {
...
//    });
    // $("#prev_button_a,#next_button_a,#today_button,#mainCal .cont
    // td,.jp-dropdown-menu li").click(function(){
    //
    // });
    /*  $(".today").unbind();
...
//
//    var editorHtml =
//            "<div class='fll'>添加记事: &nbsp;</div><div class='jp-dropdown noteTypeWarp' id='noteTypedd'>\
...
//                    '<div title="事件数" class="agenda">' + eventDataList[d].count + '</div>');
//        }
//    }
//}
//
...
//                        var width = $(this).width();
//                        var $eventsWarp =
//                                $("<div class='jp-popover' style='top:" + (offset.top + height - 5) + "px;left:"
//                                        + (offset.left - 77 + width) + "px;'></div>");
//
//                        var htmlStr =
//                                '<div class="blankarrow"><div class="arrow_dk"></div><div class="arrow_lt"></div></div>\
...
//                                    } else {
//                                        htmlStr +=
//                                                "<li ctype='" + eventObject.content_type + "' contentid='"
//                                                        + eventObject.content_id + "' time='" + eventObject.happen_time
//                                                        + "' title='" + eventObject.summary + "'><span class='"
//                                                        + eventObject.content_type
//                                                        + "_icon'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>"
